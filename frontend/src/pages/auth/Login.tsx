    ...
    return (
        <div className="h-screen w-screen flex bg-gray-50 overflow-hidden font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gray-900 relative items-center justify-center overflow-hidden">
                {/* Subtle glassmorphism/geometric background touches */}
                ...
                <div className="relative z-10 p-12 max-w-xl text-white">
                    <h2 className="text-4xl font-light tracking-wide mb-6">Smarter Learning.</h2>
                    <p className="text-gray-400 text-lg font-light leading-relaxed">
                        An intelligent, minimal approach to your educational journey. Focus on what matters, without the noise.
                    </p>
                </div>
            </div>
                ...
                >
                    ...
                    <div className="mt-8 text-center text-sm">
                        <p className="text-gray-500">
                            ...
                            <Link to="/signup" className="text-indigo-600 font-medium hover:text-indigo-500 transition-colors duration-200">
                                Sign up
                            </Link>
                        </p>
                    </div>
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex justify-end pt-1">
                <Link
                    to="/forgot-password"
                    className="cursor-pointer text-xs text-gray-500 hover:text-indigo-600 transition-colors duration-200"
                >
                    Forgot password?
                </Link>
            </div>
